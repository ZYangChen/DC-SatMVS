...
parser.add_argument('--dataset_root', default='/remote-home/Cs_ai_qj_new/chenziyang/MVS/MVSrs', help='dataset root')
...
# parser.add_argument('--ndepths', type=str, default="64,48,32,8", help='ndepths')
parser.add_argument('--min_interval', type=float, default=2.5, help='min_interval in the bottom stage')
# parser.add_argument('--depth_inter_r', type=str, default="8,4,2,1", help='depth_intervals_ratio')
...
# parser.add_argument('--cr_base_chs', type=str, default="8,8,8,8", help='cost regularization base channels')
